...
**移动范围限制在自机中心点必须处于显示像素(160x160)范围内**
...
##### 高爆子弹包
    ...
    每间隔一段时间(暂定30s-60s)随机出现在顶端并与敌机以相同速度下落
...
##### 双倍子弹包
    ...
    每间隔一段时间(暂定20s-60s)随机出现在顶端并与敌机以相同速度下落
...
##### ``激光束子弹包``(初稿不考虑 2期工程)
    ...
    每间隔一段时间(暂定45s-90s)随机出现在顶端并与敌机以相同速度下落
...
##### ``追踪子弹包``(初稿不考虑 2期工程)
    ...
    每间隔一段时间(暂定60s-90s)随机出现在顶端并与敌机以相同速度下落
...
##### ``清屏炸弹包``(初稿不考虑 2期工程)
    ...
    每间隔一段时间(暂定120s-150s)随机出现在顶端并与敌机以相同速度下落
...
##### 血量恢复包
    ...
    每间隔一段时间(暂定60s-120s)随机出现在顶端并与敌机以相同速度下落
