...
1. 子弹击中敌机特效: 敌机体颜色(2种)闪烁1次100ms(待讨论)

2. 敌机被摧毁特效: 被摧毁敌机从几何中心开始爆炸/消失(待讨论)

3. 激光束子弹切换特效: 自机获得激光束子弹包后, 自机头端显示由大光束缩窄直径的过程动效(待讨论)

4. 自机获得特殊道具包特效: 自机机体颜色(2种)闪烁2次500ms(待讨论)
